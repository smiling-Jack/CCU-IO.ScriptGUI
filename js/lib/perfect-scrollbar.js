    ...
    $.fn.perfectScrollbar = function (suppliedSettings, option) {
        ...
        return this.each(function () {
            ...
            var $scrollbarXRail = $("<div class='ps-scrollbar-x-rail'></div>").appendTo($this),
                ...
                $scrollbarX = $("<div class='ps-scrollbar-x frame_color'></div>").appendTo($scrollbarXRail),
                $scrollbarY = $("<div class='ps-scrollbar-y frame_color'></div>").appendTo($scrollbarYRail),
                scrollbarXActive,
                scrollbarYActive,
                containerWidth,
                containerHeight,
            ...
            var initialize = function () {
                ...
                updateContentScrollLeft(settings.left);
                updateContentScrollTop(settings.top);
