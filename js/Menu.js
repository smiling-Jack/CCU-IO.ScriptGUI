...
jQuery.extend(true, SGI, {
    ...
    menu_iconbar: function () {
        ...
        $("#m_make-image").click(function () {
//            var fbs = $(".fbs_selected");

            var fbs = $(".fbs_selected, ._jsPlumb_endpoint")
            canvg();
            fbs.detach().appendTo('html')
            $("body").remove()
            $(".fbs_selected, ._jsPlumb_endpoint").wrapAll('<div id="photo" style="position: relative"></div>');

            var left = $("._jsPlumb_endpoint").position().left;
            var top = $(".fbs_selected").position().top;

            $.each($("._jsPlumb_endpoint"), function () {
                var _top = $(this).position().top;
                var _left = $(this).position().top;
                $(this).css({
//                    position: "relative",
